...
const issueBookValidation = function (issueDetails){
    if(!issueDetails.bookId || !issueDetails.bookName || !issueDetails.author ||  !issueDetails.genre || !issueDetails.memberDetails ){
...
const returnBookValidation = function (returnBook){
    if(!returnBook.bookId || !returnBook.bookName || !returnBook.author || !returnBook.genre  || !returnBook.memberDetails){
        return constResponse.fieldMissingError;
    }
