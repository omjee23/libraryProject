...
const bookRegisterValidation = function (bookData) {
    if(!bookData.bookId || !bookData.bookName || !bookData.author || !bookData.price || !bookData.genre || !bookData.status){
...
module.exports = {bookRegisterValidation ,getBookValidation , updateBookValidation , deleteBookValidation}